...
- **Accommodation** section added between Venue and Schedule as a placeholder — user will supply local stays to list.
- **Next:** fill Accommodation (local stays), Schedule, then RSVP. RSVP will need a no-backend approach (Google Form / Formspree / mailto) since the site is static.
